...
def aug_flip(meta, img, mask_miss, params_transform, coco=True, neworder=False):
    ...
    if doflip:
        ...
        if coco:
            ...
            meta['joint_self'] = meta['joint_self'][[5, 4, 3, 2, 1, 0, 6, 7, 8, 9, 15, 14, 13, 12, 11, 10]]
        ...
        if (num_other_people != 0):
            ...
            for i in range(num_other_people):
                if coco:
                    ...
                    meta['joint_others'][i] = meta['joint_others'][i][[5, 4, 3, 2, 1, 0, 6, 7, 8, 9, 15, 14, 13, 12, 11, 10]]
